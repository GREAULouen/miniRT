...
/*   Updated: 2024/06/05 16:11:13 by lgreau           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	res->x = dir->x * (*rot)[0][0] + dir->y * (*rot)[0][1] + dir->z
		* (*rot)[0][2];
	res->y = dir->x * (*rot)[1][0] + dir->y * (*rot)[1][1] + dir->z
		* (*rot)[1][2];
	res->z = dir->x * (*rot)[2][0] + dir->y * (*rot)[2][1] + dir->z
		* (*rot)[2][2];
}
